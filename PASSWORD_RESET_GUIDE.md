...
FRONTEND_URL="https://patient-portal-99.preview.emergentagent.com"
```
...
curl -X POST "https://patient-portal-99.preview.emergentagent.com/api/webhook/ghl?webhook_secret=YOUR_SECRET" \
  -H "Content-Type: application/json" \
  -d '{"email": "test@example.com", "name": "Test User"}'

# Request password reset
curl -X POST "https://patient-portal-99.preview.emergentagent.com/api/auth/request-reset" \
  -H "Content-Type: application/json" \
...
2. **Visit reset URL:**
```
https://patient-portal-99.preview.emergentagent.com/reset-password?token=TOKEN_FROM_DB
```
