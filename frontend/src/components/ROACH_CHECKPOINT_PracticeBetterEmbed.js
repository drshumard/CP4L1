/**
 * ROACH CHECKPOINT - Practice Better Booking Embed Component
 * ============================================================
 * 
 * This is the saved version of the Practice Better booking integration.
 * To restore: Copy this file back to PracticeBetterEmbed.js
 * 
 * Features:
 * - Practice Better iframe embedding
 * - localStorage session persistence
 * - Redirect handling (?booking=success URL param)
 * - postMessage detection for booking completion
 * - Manual "I've Booked My Call" fallback button
 * - Backend webhook polling for step advancement
